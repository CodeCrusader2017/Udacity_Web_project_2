...
function setBubbleBackground(evt) {
    ...
    document.querySelector('#section' + evt.target.textContent.substring(8)).scrollIntoView({behavior: 'smooth'}); //ref: https://stackoverflow.com/questions/3163615/how-to-scroll-an-html-page-to-a-given-anchor
}
